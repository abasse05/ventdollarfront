...
import '../../styles/VendeurContent.css'
                  ...
                  <div className="col-md-offset-3 col-md-9" style={{margin:"10 auto"}}>
                      <div className="form-containerss form-mains">
                          <div className="row bg-dark">
                              <h3 className="title text-left text-white text-center tilte-texte">Vendeurs agrés de Dollars Exchanger</h3>
                          </div>
